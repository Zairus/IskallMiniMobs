...
{
	ResourceLocation textures = new ResourceLocation(MMConstants.MODID, "textures/models/mm_naming.png");
	
	private ModelMMNamingStation model;
	
	public RenderMMNamingStation()
	{
		this.model = new ModelMMNamingStation();
	}
